...
## Data
None collected. The paper is purely theoretical/re-analytic: it derives comparative statics and then confronts them with **published** experimental datasets (Forsythe et al. 1994 dictator/ultimatum; Roth et al. 1991 four-country auction markets; [[@Fehr1993|Fehr et al. 1993]] gift-exchange, generously shared by the authors; Berg et al. 1995 investment game; Bolton-Zwick 1995 impunity; Prasnikar-Roth 1992 best-shot; Cooper et al. 1996 and Andreoni-Miller 1993 PD). The [[@Fehr1993|Fehr et al. (1993)]] 276 wage-effort pairs are used to *fit* $\alpha$.
