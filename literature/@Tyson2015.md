...
topics: []
related: [Bernheim2009, Cherepanov2013, Manzini2007, Masatlioglu2012, Salant2008, Samuelson1938, Tyson2008]
added: 2026-05-30
...
## Connections
Builds directly on [[@Tyson2008|Tyson (2008)]] one-stage satisficing and on Simon (1955). The composite operator places the model inside the **consideration-set** framework $C(A)=G(\sigma(A),R^2)$ with $\sigma=G(\cdot,\mathbf{R}^1)$, and the paper carefully shows it is *structurally unrelated* to the attention-filter model of [[@Masatlioglu2012|Masatlioglu, Nakajima & Ozbay (2012)]], the consideration filters of Lleras et al. (2010) and [[@Cherepanov2013|Cherepanov, Feinberg & Sandbu (2013)]], the rational shortlist methods / categorize-then-choose of [[@Manzini2007|Manzini & Mariotti]] (2007, 2012), and Spears (2011). Lexicographic, noncompensatory structure connects to Manzini & Mariotti's sequential heuristics. The framing connection runs through [[@Salant2008|Salant & Rubinstein (2008)]]: with $R^2$ as payoff-irrelevant framing information, aggregating over frames collapses to satisficing without a secondary criterion, and their choice-from-lists satisficing is a special case of Eq. 2. Welfare methodology follows [[@Bernheim2009|Bernheim (2009)]] and [[@Bernheim2009|Bernheim & Rangel (2009)]], with revealed-preference roots in Richter (1966), Sen (1969, 1993), [[@Samuelson1938|Samuelson (1938)]], Arrow (1959), and [[@Salant2008|Rubinstein & Salant (2008)]]; Szpilrajn (1930) supplies the extension lemma.
