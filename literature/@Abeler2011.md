...
- **Expectation-based reference dependence** (Kőszegi-Rabin 2007, choice-acclimating personal equilibrium; Bell 1985, Loomes-Sugden 1986, Gul 1991 give similar predictions). Consumption utility is linear; gain-loss utility is $\mu(s)=\eta s$ for $s\geq 0$ and $\mu(s)=\eta\lambda s$ for $s<0$, with $\eta\geq 0$, $\lambda>1$ (losses loom larger). Effort cost is borne in both states so it does not enter gain-loss utility. For $we<f$:
...
- The authors explicitly note they cannot distinguish *which* specification of the expectation-based reference point is empirically correct: the **mean** of expected outcomes (Bell 1985; Loomes-Sugden 1986; Gul 1991) vs the **whole distribution** of expected outcomes (Kőszegi-Rabin 2006, 2007). Both predict clustering at a single $f$.
...
## Connections
Squarely within the Kőszegi-Rabin (2006, 2007) program on expectation-based reference-dependent preferences, with the choice-acclimating personal equilibrium as the operative solution concept; precursors Bell (1985), Loomes-Sugden (1986), Gul (1991), and Shalev (2000) supply the disappointment-aversion lineage, all grounded in Kahneman-Tversky (1979) loss aversion. It contrasts with status-quo reference-point work (Kahneman-Knetsch-Thaler 1990 endowment effect; Odean 1998; Genesove-Mayer 2001). The labor-supply application engages Camerer-Babcock-Loewenstein-Thaler (1997), Fehr-Götte (2007), Farber (2005, 2008), Crawford-Meng (2008), and Doran (2009) on daily income targeting. The incentivized loss-aversion measure follows Fehr-Götte (2007) and Gächter-Herrmann-Johnson (2007) and invokes Rabin's (2000) calibration critique to separate loss aversion from risk aversion. The goal-setting discussion links to Locke-Latham (1990, 2002), Heath-Larrick-Wu (1999), and Koch-Nafziger (2008).
