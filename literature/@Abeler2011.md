...
- The authors explicitly note they cannot distinguish *which* specification of the expectation-based reference point is empirically correct: the **mean** of expected outcomes ([[@Bell1985|Bell 1985]]; [[@Loomes1986|Loomes-Sugden 1986]]; [[@Gul1991|Gul 1991)]] vs the **whole distribution** of expected outcomes (Kőszegi-[[@Koszegi2006b|Rabin 2006]], 2007). Both predict clustering at a single $f$.
