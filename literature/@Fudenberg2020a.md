...
- **Across-treatment extrapolation.** Holding out entire $\Delta_{RD}$-groups, IRL-SG (MSE 0.0177, 80.0% improvement) is *significantly* better than the best ML (SVR, 0.0235) — most model-free methods even fall below OLS-on-$\Delta_{RD}$. This echoes Andrews, Fudenberg, Liang & Wu (2022): structured models extrapolate better.
