...
## Connections
The benchmark maximal-element rule descends from Sen (1971), Schwartz (1976), Moulin (1985), Bossert–Sprumont–Suzumura (2005); the WARP/Arrow (1959) foundation and Sen's $\alpha,\beta,\gamma$ are the reference axioms relaxed here. The attraction effect originates with Huber, Payne & Puto (1982); the compromise effect with Simonson (1989); the similarity effect with Debreu (1960) and Tversky (1972). Mariotti (2008)'s "justification by an asymmetric relation" framing motivates PD's weakening (every chosen option need only $J$-dominate *some* rejected one), and is contrasted with von Neumann–Morgenstern stable sets. The three rival models of the attraction effect are Lombardi (2009), de Clippel & Eliaz (2012), and Ok, Ortoleva & Riella (2015); related bounded-rationality machinery includes Manzini & Mariotti (2007) sequential/rational-shortlist choice, Eliaz, Richter & Rubinstein (2011), Masatlioglu–Nakajima–Ozbay (2012) revealed attention, and Bordalo–Gennaioli–Shleifer (2013) salience. The welfare-recovery link runs through Bernheim & Rangel (2009), with related elicitation work by Rubinstein & Salant (2012), Manzini & Mariotti (2012), Cherepanov–Feddersen–Sandroni (2013), and Fleurbaey & Schokkaert (2013). Incomparability-versus-indifference foundations draw on Eliaz & Ok (2006), Mandler (2009), and the author's own Gerasimou (2012).
